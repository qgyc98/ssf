...
/**
   ...
   JK, 29.3.2002
*/
void axisymlt::bf_matrix (matrix &n,vector &areacoord)
{
  double xi,eta;
  vector bf(nne);
...
/**
   ...
   JK, 17.8.2001
*/
void axisymlt::stiffness_matrix_block (long eid,long ri,long ci,matrix &sm)
{
  long i,ii,jj,ipp;
  double jac,det,r;
  vector gp1,gp2,w,x(nne),y(nne),areacoord(3);
...
void axisymlt::res_stiffness_matrix (long eid,matrix &sm)
{
  ...
  if (nb==3){
    stiffness_matrix_block (eid,0,0,sm);
  }
...
/**
   ...
   JK, 16. 6. 2019
*/
void axisymlt::res_mass_matrix (long eid,matrix &mm)
{
  long transf;
...
*/
void axisymlt::edge_integral (long edg,vector &x,vector &y,long /*intord*/,vector &gp,vector &w,
...
/**
   ...
   JK, 19.8.2004
*/
void axisymlt::edgenodeval (long edg,vector &nodval,double *list)
{
  long i,j,k,l;
...
/**
   ...
   JK, 3.11.2007
*/
void axisymlt::edgeload (long eid,long *le,double *list,vector &nf)
{
  long i;
...
/**
   ...
   10.5.2002
*/
void axisymlt::nod_other_ip (long eid)
{
  long i,j,ncompo;
...
/**
   ...
   TKo 7.2008
*/
void axisymlt::internal_forces (long lcid,long eid,long ri,long ci,vector &ifor,vector &x,vector &y)
{
  integratedquant iq;
  iq=locstress;
...
/**
   ...
   TKo 7.2008
*/
void axisymlt::nonloc_internal_forces (long lcid,long eid,long ri,long ci,vector &ifor,vector &x,vector &y)
{
  integratedquant iq;
  iq=nonlocstress;
...
/**
   ...
   TKo 7.2008
*/
void axisymlt::incr_internal_forces (long lcid,long eid,long ri,long ci,vector &ifor,vector &x,vector &y)
{
  integratedquant iq;
  iq=stressincr;
...
/**
   ...
   TKo, 7.2008
*/
void axisymlt::res_nonloc_internal_forces (long lcid,long eid,vector &ifor)
{
  long transf;
  ivector nodes (nne);
  vector v(ndofe),x(nne),y(nne);
...
/**
   ...
   TKo, 7.2008
*/
void axisymlt::res_incr_internal_forces (long lcid,long eid,vector &ifor)
{
  long transf;
  ivector nodes (nne);
  vector v(ndofe),x(nne),y(nne);
...
/**
   ...
   TKo, 7.2008
*/
void axisymlt::compute_nonloc_nlstress(long /*lcid*/,long eid,long ri,long ci)
{
  long i,ii,ipp;
...
/**
   ...
   TKo, 7.2008
*/
void axisymlt::compute_nlstressincr(long /*lcid*/,long eid,long ri,long ci)
{
  long i,ii,ipp;
...
void axisymlt::compute_eigstress(long /*lcid*/,long eid,long ri,long ci)
{
  long i,ii,ipp;
...
/**
   ...
   TKo 7.2008
*/
void axisymlt::elem_integration (integratedquant iq,long lcid,long eid,long ri,long ci,vector &nv,vector &x,vector &y)
{
  long i,ii,ipp;
  double rad,det;
...
/**
   ...
   19.1.2002
*/
void axisymlt::ipcoord (long eid,long ipp,long ri,long ci,vector &coord)
{
  long i,ii,jj,aipp;
  vector x(nne),y(nne);
...
void axisymlt::ipncoord(long eid, long ipp, vector &coord)
{
  long i, ii, jj, aipp;
  vector w, gp1, gp2;
