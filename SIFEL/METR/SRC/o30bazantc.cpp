...
*/
double o30bazmatc::sat(double pc,double t)
{
...
*/
double o30bazmatc::dsat_dpc(double pc,double t)
{
  double dsw_dpc;
  double sw,rh,tamb,tem,tt1,mt1,fcm,mt;
...
*/
double o30bazmatc::dsat_dt(double pc,double t)
{
  double dsw_dt;
...
/**
   ...
   @retval phi - porosity
*/
double o30bazmatc::o30baz_phi(double t)
{
  double phi;
...
*/
double o30bazmatc::o30baz_kintr(double /*pc*/,double pg,double t,double /*dam*/)
{
  double kintr,bk;//ad;
  state_eq tt;
...
*/
double o30bazmatc::o30baz_krg(double pc,double t)
{
  double krg,s;
...
*/
double o30bazmatc::o30baz_krw(double pc,double t,double rh)
{
  double krw,help,s;
...
*/
double o30bazmatc::o30baz_deff(double pc,double pg,double t)
{
...
*/
double o30bazmatc::o30baz_cps(double t)
{
  double cps;
...
*/
double o30bazmatc::o30baz_rhocp(double pc,double pg,double t,long /*ipp*/)
{
...
*/ 
double o30bazmatc::o30baz_fs(double /*pc*/,double /*pg*/,double t)
{
  double f,fs;
...
*/
double o30bazmatc::o30baz_lambdas(double t)
{
  double lambdas;
...
*/
double o30bazmatc::o30baz_lambdaeff(double pc,double /*pg*/,double t)
{
...
*/
double o30bazmatc::o30baz_rhos(double t)
{
  double rhos;
...
*/
double o30bazmatc::o30baz_betas()
{
  return(betas);
}
...
*/
double o30bazmatc::o30baz_hydw(double /*pc*/,double /*pg*/,double t)
{
  double fhy,hydw;
...
*/
double o30bazmatc::o30baz_dehydw_dt(double /*pc*/,double /*pg*/,double t)
{
...
*/
double o30bazmatc::o30baz_hydren(double /*pc*/,double /*pg*/,double /*t*/)
{
  return(hydren);
}
...
*/
double o30bazmatc::o30baz_fste(double /*pc*/,double /*pg*/,double /*t*/)
{
  return(fste);
}
...
*/
double o30bazmatc::o30baz_ddbw(double /*pc*/,double /*pg*/,double t)
{
  double ddbw;
...
*/
double o30bazmatc::o30baz_fct(double /*pc*/,double /*pg*/,double t)
{
  double fct,ttc;
...
*/
double o30bazmatc::o30baz_xk0(double /*pc*/,double /*pg*/,double t)
{
  double xk0;
...
*/
double o30bazmatc::o30baz_alpha()
{
  return(alpha);
}
