...
*/
double C30barmat::sat(double pc,double t)
{
...
*/
double C30barmat::dsat_dpc(double pc,double t)
{
  double dsw_dpc;
...
*/
double C30barmat::dsat_dt(double pc,double t)
{
...
/**
   ...
   @retval phi - porosity
*/
double C30barmat::C30bar_phi(double t)
{
  double phi;
...
*/
double C30barmat::C30bar_kintr(double /*pc*/,double pg,double t,double dam)
{
  double kintr,bk,ad;
  state_eq tt;
...
*/
double C30barmat::C30bar_krg(double pc,double t)
{
  double krg,s;
...
*/
double C30barmat::C30bar_krw(double pc,double t,double rh)
{
  double krw,help,s;
...
/**
   ...
   @retval dd - ...
*/
double C30barmat::C30bar_dd(double pc,double t)
{
  double tau,dd;
...
*/
double C30barmat::C30bar_deff(double pc,double pg,double t)
{
...
*/
double C30barmat::C30bar_cps(double t)
{
  double cps;
...
*/
double C30barmat::C30bar_rhocp(double pc,double pg,double t)
{
...
*/ 
double C30barmat::C30bar_tau(double pc,double t)
{
  double phi,s,tau;
...
*/
double C30barmat::C30bar_lambdas(double t)
{
  double lambdas;
...
*/
double C30barmat::C30bar_lambdaeff(double pc,double /*pg*/,double t)
{
...
*/
double C30barmat::C30bar_hydw(double /*pc*/,double /*pg*/,double t)
{
  double fhy,hydw;
...
*/
double C30barmat::C30bar_dehydw_dt(double /*pc*/,double /*pg*/,double t)
{
...
*/
double C30barmat::C30bar_hydren(double /*pc*/,double /*pg*/,double /*t*/)
{
  return(hydren);
}
...
*/
double C30barmat::C30bar_fste(double /*pc*/,double /*pg*/,double /*t*/)
{
  return(fste);
}
...
*/
double C30barmat::C30bar_ddbw(double /*pc*/,double /*pg*/,double t)
{
  double ddbw;
...
*/
double C30barmat::C30bar_emod(double /*pc*/,double /*pg*/,double t)
{
  double emod,ttc;
...
*/
double C30barmat::C30bar_fct(double /*pc*/,double /*pg*/,double t)
{
  double fct,ttc;
...
/**
   ...
   29. 11. 2013, by TKo
*/
void C30barmat::give_reqntq(long *antq)
{
  //  damage parameter
