/*
    ...
    sources:          CTU Reports 1,2001 Volume 5
*/ 
...
{
  //
  emod = 1.3e6;//Young's modulus [Pa]
  //
  nu = 0.4;//Poisson's ratio [-]
  //
  alpha = 0.0001;//Biot's constant [-] alpha = 1 - kt/ks
  //
  ks = 1.0e12;//bulk modulus of solid phase (grains) [Pa]
  //
  kw = 2.0e9;//bulk modulus of water [Pa]
  //
  //ka = 0.1e6;//bulk modulus of air [Pa]
  //
  phi0 = 0.2975;//initial porosity [-]
  //
...
/**
   ...
   12/9/2008, TKr
*/
double sejtkrmat::get_sw(double pw)
{
  //predelat??!!
  double sw,pc;
  //
...
/**
   ...
   12/9/2008, TKr
*/
double sejtkrmat::get_dsw_dpw(double pw)
{
  //predelat??!!
  double dsw_dpc,pc;
  //
...
/**
   ...
   12/9/2008, TKr
*/
double sejtkrmat::get_krw(double pw)
{
  double krw,s;
...
double sejtkrmat::get_fu1(double pw)
{
  ...
  fu1 = rhos*(n-1) + sw*n*rhow;//toto zkontrolovat!!
