/*
  File:     linwedget.cpp
  Author:   Jaroslav Kruis, 6. 3. 2024
  Purpose:  3D wedge element with linear approximation functions
*/
...
linwedget::linwedget (void)
{
  ...
  //  there are also surfaces with 3 nodes but 4 is used
  nnsurf=4;
  ...
  dofe = new long* [ntm];
  nip = new long* [ntm];
  intordkmt = new long* [ntm];
  intordkmz = new long* [ntm];
  intordcmt = new long* [ntm];
  intordcmz = new long* [ntm];
  ordering = new long* [ntm];
  for (i=0;i<ntm;i++){
    dofe[i] = new long [ntm];
    nip[i] = new long [ntm];
    intordkmt[i] = new long [ntm];
    intordkmz[i] = new long [ntm];
    intordcmt[i] = new long [ntm];
    intordcmz[i] = new long [ntm];
  ...
  case nomedium:{  break; }
  case onemedium:{
    ordering[0][0]=1;  ordering[0][1]=2;  ordering[0][2]=3;  ordering[0][3]=4;  ordering[0][4]=5;  ordering[0][5]=6;
    
    dofe[0][0]=6;

    intordkmt[0][0]=3;   intordkmz[0][0]=2;
    intordcmt[0][0]=3;   intordcmz[0][0]=2;
  ...
  case twomediacoup:{
    ordering[0][0]=1;  ordering[0][1]=3;  ordering[0][2]=5;  ordering[0][3]=7;  ordering[0][4]=9;  ordering[0][5]=11;
    ordering[1][0]=2;  ordering[1][1]=4;  ordering[1][2]=6;  ordering[1][3]=8;  ordering[1][4]=10; ordering[1][5]=12;

    intordkmt[0][0]=3;  intordkmt[0][1]=3;  intordkmt[1][0]=3;  intordkmt[1][1]=3;
    intordkmz[0][0]=2;  intordkmz[0][1]=2;  intordkmz[1][0]=2;  intordkmz[1][1]=2;
    intordcmt[0][0]=3;  intordcmt[0][1]=3;  intordcmt[1][0]=3;  intordcmt[1][1]=3;
    intordcmz[0][0]=2;  intordcmz[0][1]=2;  intordcmz[1][0]=2;  intordcmz[1][1]=2;
    
    if (Tp->savemode==0){
      nip[0][0]=12;      nip[0][1]=12;      nip[1][0]=12;      nip[1][1]=12;
    }
    if (Tp->savemode==1){
      nip[0][0]=12;      nip[0][1]=0;      nip[1][0]=0;      nip[1][1]=0;
    }
    
    dofe[0][0]=6;  dofe[0][1]=6;  dofe[1][0]=6;  dofe[1][1]=6;
  ...
  case threemediacoup:{
    ordering[0][0]=1;  ordering[0][1]=4;  ordering[0][2]=7;  ordering[0][3]=10;  ordering[0][4]=13; ordering[0][5]=16;
    ordering[1][0]=2;  ordering[1][1]=5;  ordering[1][2]=8;  ordering[1][3]=11;  ordering[1][4]=14; ordering[1][5]=17;
    ordering[2][0]=3;  ordering[2][1]=6;  ordering[2][2]=9;  ordering[2][3]=12;  ordering[2][4]=15; ordering[2][5]=18;


    intordkmt[0][0]=3;  intordkmt[0][1]=3;  intordkmt[0][2]=3;
    intordkmt[1][0]=3;  intordkmt[1][1]=3;  intordkmt[1][2]=3;
    intordkmt[2][0]=3;  intordkmt[2][1]=3;  intordkmt[2][2]=3;

    intordkmz[0][0]=2;  intordkmz[0][1]=2;  intordkmz[0][2]=2;
    intordkmz[1][0]=2;  intordkmz[1][1]=2;  intordkmz[1][2]=2;
    intordkmz[2][0]=2;  intordkmz[2][1]=2;  intordkmz[2][2]=2;

    intordcmt[0][0]=3;  intordcmt[0][1]=3;  intordcmt[0][2]=3;
    intordcmt[1][0]=3;  intordcmt[1][1]=3;  intordcmt[1][2]=3;
    intordcmt[2][0]=3;  intordcmt[2][1]=3;  intordcmt[2][2]=3;

    intordcmz[0][0]=2;  intordcmz[0][1]=2;  intordcmz[0][2]=2;
    intordcmz[1][0]=2;  intordcmz[1][1]=2;  intordcmz[1][2]=2;
    intordcmz[2][0]=2;  intordcmz[2][1]=2;  intordcmz[2][2]=2;

    if (Tp->savemode==0){
      nip[0][0]=12;      nip[0][1]=12;      nip[0][2]=12;
      nip[1][0]=12;      nip[1][1]=12;      nip[1][2]=12;
      nip[2][0]=12;      nip[2][1]=12;      nip[2][2]=12;
    }
    if (Tp->savemode==1){
      nip[0][0]=12;      nip[0][1]=0;      nip[0][2]=0;
      nip[1][0]=0;       nip[1][1]=0;      nip[1][2]=0;
      nip[2][0]=0;       nip[2][1]=0;      nip[2][2]=0;
    }
    
    dofe[0][0]=6;      dofe[0][1]=6;      dofe[0][2]=6;
    dofe[1][0]=6;      dofe[1][1]=6;      dofe[1][2]=6;
    dofe[2][0]=6;      dofe[2][1]=6;      dofe[2][2]=6;
...
void linwedget::codnum (long *cn,long ri)
{
  long i;
  for (i=0;i<nne;i++){
    cn[i]=ordering[ri][i];
...
/**
   ...
   JK, 6. 3. 2024
*/
double linwedget::element_volume (long eid)
{
  long i,j,ri,ci;
  ri=0;  ci=0;
  ...
  reallocv(RSTCKVEC(intordkmz[ri][ci],w));
  reallocv(RSTCKVEC(intordkmz[ri][ci],gp));
  reallocv(RSTCKVEC(intordkmt[ri][ci],wt));
  reallocv(RSTCKVEC(intordkmt[ri][ci],gp1));
  reallocv(RSTCKVEC(intordkmt[ri][ci],gp2));

  gauss_points (gp.a,w.a,intordkmz[ri][ci]);
  gauss_points_tr (gp1.a,gp2.a,wt.a,intordkmt[ri][ci]);
  
  vol=0.0;
  for (i=0;i<intordkmt[ri][ci];i++){
    xi=gp1[i];  eta=gp2[i];
    for (j=0;j<intordkmz[ri][ci];j++){
      zeta=gp[j];
...
/**
   ...
   JK, 6. 3. 2024
*/
double linwedget::approx (double xi,double eta,double zeta, vector &nodval)
{
  double f;
  vector bf(nne);
  
  bf_lin_wed_3d (bf.a,xi,eta,zeta);
...
/**
   ...
   JK, 6. 3. 2024
*/
void linwedget::intpointval (long eid)
{
  long i,j,l,ii,jj,ipp;
  double xi,eta,zeta,val;
  vector x(nne),y(nne),z(nne),w,wt,gp,gp1,gp2;
  vector r(ASTCKVEC(ndofe)),t(ASTCKVEC(nne));
  ...
  for (l=0;l<Tp->ntm;l++){
	...
	reallocv(RSTCKVEC(intordkmz[ii][jj],w));
	reallocv(RSTCKVEC(intordkmz[ii][jj],gp));
	reallocv(RSTCKVEC(intordkmt[ii][jj],wt));
	reallocv(RSTCKVEC(intordkmt[ii][jj],gp1));
	reallocv(RSTCKVEC(intordkmt[ii][jj],gp2));
	
	gauss_points (gp.a,w.a,intordkmz[ii][jj]);
	gauss_points_tr (gp1.a,gp2.a,wt.a,intordkmt[ii][jj]);

	ipp=Tt->elements[eid].ipp[ii][jj];
	for (i=0;i<intordkmt[ii][jj];i++){
	  xi=gp1[i];  eta=gp2[i];
	  for (j=0;j<intordkmz[ii][jj];j++){
	    zeta=gp[j];
	...
	reallocv (intordcmz[ii][jj],w);
	reallocv (intordcmz[ii][jj],gp);
	reallocv (intordcmt[ii][jj],wt);
	reallocv (intordcmt[ii][jj],gp1);
	reallocv (intordcmt[ii][jj],gp2);
	
	gauss_points (gp.a,w.a,intordcmz[ii][jj]);
	gauss_points_tr (gp1.a,gp2.a,wt.a,intordcmt[ii][jj]);

	for (i=0;i<intordcmt[ii][jj];i++){
	  xi=gp1[i];  eta=gp2[i];
	  for (j=0;j<intordcmz[ii][jj];j++){
	    zeta=gp[j];
...
*/
/*
void linwedget::intpointval_puc (long eid)
{
...
/**
  ...
  JK, 6. 3. 2024
*/
void linwedget::initintpointval (long eid)
{
  long i,j,l,ii,jj,ipp,ndofn,cndofn;
  double xi,eta,zeta,val;
  ivector enod(ASTCKIVEC(nne));
  vector rr, r(ASTCKVEC(ndofe)), t(ASTCKVEC(nne)), gp, w,gp1,gp2,wt;
  ...
  for (l=0;l<Tp->ntm;l++){
	...
	reallocv (intordkmz[ii][jj],w);
	reallocv (intordkmz[ii][jj],gp);
	reallocv (intordkmt[ii][jj],wt);
	reallocv (intordkmt[ii][jj],gp1);
	reallocv (intordkmt[ii][jj],gp2);
...
/**
   ...
   JK, 31.3.2002
*/
void linwedget::intpointgrad (long eid)
{
  long i,j,l,ii,jj,ipp;
  double xi,eta,zeta,jac;
  vector x(ASTCKVEC(nne)),y(ASTCKVEC(nne)),z(ASTCKVEC(nne)),r(ASTCKVEC(ndofe));
  vector gp,gp1,gp2,w,wt,grad(ASTCKVEC(ncomp)),t(ASTCKVEC(nne));
...
*/
 /*
void linwedget::intpointflux (long eid)
{
  long i,j,k,l,ii,jj,ipp;
...
*/
  /*
void linwedget::average_flux (long lcid,long eid,vector &avfl)
{
...
*/
   /*
void linwedget::intpointother (long eid)
{
...
/**
   ...
   JK, 6. 3. 2024
*/
void linwedget::bf_matrix (matrix &n,double xi,double eta,double zeta)
{
  nullm (n);
...
/**
   ...
   JK, 6. 3. 2024
*/
void linwedget::grad_matrix (matrix &gm,vector &x,vector &y,vector &z,double xi,double eta,double zeta,double &jac)
{
  long i;
  vector dx(nne),dy(nne),dz(nne);

  dx_bf_lin_wed_3d (dx.a,zeta);
  dy_bf_lin_wed_3d (dy.a,zeta);
  dz_bf_lin_wed_3d (dz.a,xi,eta);
...
/**
   ...
   JK, 6. 3. 2024
*/
void linwedget::conductivity_matrix (long lcid,long eid,long ri,long ci,matrix &km)
{
  long i,j,ipp;
  double xi,eta,zeta,jac;
  ivector nodes(nne);
  ...
  reallocv (intordkmz[ri][ci],w);
  reallocv (intordkmz[ri][ci],gp);
  reallocv (intordkmt[ri][ci],wt);
  reallocv (intordkmt[ri][ci],gp1);
  reallocv (intordkmt[ri][ci],gp2);
...
*/
/*
void linwedget::l_matrix (long lcid,long eid,long ri,long ci,matrix &lm)
{
  long i,j,k,ii;
...
*/
/*
void linwedget::l_t_matrix (long lcid,long eid,long ri,long ci,matrix &lm)
{
  long i,j,k,ii;
  double xi,eta,zeta,ww1,ww2,ww3,jac;
  ivector nodes(nne);
...
/**
   ...
   JK, 6. 3. 2024
*/
void linwedget::capacity_matrix (long eid,long ri,long ci,matrix &cm)
{
  long i,j,ipp;
  double jac,xi,eta,zeta,rho,c;
  ivector nodes(nne);
  vector x(nne),y(nne),z(nne),dens(nne),w,wt,gp,gp1,gp2;
  matrix n(1,dofe[ri][ci]);
  ...
  reallocv (intordcmz[ri][ci],w);
  reallocv (intordcmz[ri][ci],gp);
  reallocv (intordcmt[ri][ci],wt);
  reallocv (intordcmt[ri][ci],gp1);
  reallocv (intordcmt[ri][ci],gp2);

  gauss_points (gp.a,w.a,intordcmz[ri][ci]);
  gauss_points_tr (gp1.a,gp2.a,wt.a,intordcmt[ri][ci]);
  
  nullm (cm);
  
  if (Tp->savemode==0)
    ipp=Tt->elements[eid].ipp[ri][ci]+intordkmz[ri][ci]*intordkmt[ri][ci];
  if (Tp->savemode==1)
    ipp=Tt->elements[eid].ipp[0][0]+intordkmz[0][0]*intordkmt[0][0];
  
  
  for (i=0;i<intordcmt[ri][ci];i++){
    xi=gp1[i];  eta=gp2[i];
    for (j=0;j<intordcmz[ri][ci];j++){
      zeta=gp[j];
      
      jac_3d (jac,x,y,z,xi,eta,zeta);
      bf_matrix (n,xi,eta,zeta);
      
      c=Tm->capcoeff (ipp,ri,ci);
...
/**
   ...
   JK, 6. 3. 2024
*/
void linwedget::quantity_source_vector (vector &sv,vector &nodval,long eid,long ri,long ci)
{
  long i,j;
  double jac,xi,eta,zeta;
  vector x(nne),y(nne),z(nne),dens(nne),v(dofe[ri][ci]);
  vector w,wt,gp,gp1,gp2;
...
*/
/*
void linwedget::internal_fluxes (long lcid,long eid,vector &ifl)
{
  long i,j,k,ipp;
  double xi,eta,zeta,jac;
  ivector nodes(nne);
...
/**
   ...
   JK, 6. 3. 2024
*/
void linwedget::res_conductivity_matrix (long eid,long /*lcid*/,matrix &km)
{
  long i,j,*rcn,*ccn;
  matrix lkm;
...
/**
   ...
   TKr, 12/5/2011
*/
void linwedget::volume_rhs_vector (long lcid,long eid,long ri,long ci,vector &vrhs)
{
  long i,j,ii;
  double xi,eta,zeta,jac;
  ivector nodes(ASTCKIVEC(nne));
  vector x(ASTCKVEC(nne)),y(ASTCKVEC(nne)),z(ASTCKVEC(nne)), w(ASTCKVEC(intordkmz[ri][ci])),gp(ASTCKVEC(intordkmz[ri][ci]));
  vector wt(ASTCKVEC(intordkmt[ri][ci])),gp1(ASTCKVEC(intordkmt[ri][ci])),gp2(ASTCKVEC(intordkmt[ri][ci]));
  matrix gm(ASTCKMAT(ncomp,dofe[ri][ci])),d;
  matrix km(ASTCKMAT(dofe[ri][ci],3));
...
/**
   ...
   TKr, 12/5/2011
*/
void linwedget::res_volume_rhs_vector (vector &f,long eid,long lcid)
{
  long i;
  ivector cn;
  vector lf;
...
*/
/*
void linwedget::res_l_matrix (long eid,long lcid,matrix &lm)
{
  long i,j,*rcn,*ccn;
  matrix lkm;
...
*/
/*
void linwedget::res_l_t_matrix (long eid,long lcid,matrix &lm)
{
  long i,j,*rcn,*ccn;
  matrix lkm;
...
*/
/*
void linwedget::averd_matrix (long eid,matrix &lm)
{
  long i,j,ii,*rcn,*ccn;
  matrix d(ncomp,ncomp);
...
*/
/*
void linwedget::averc_matrix (long eid,matrix &lm)
{
  long i,j,ii;
  double c,rho;
  ivector nodes(nne);
...
*/
 /*
double linwedget::elem_volume (long eid)
{
  double jac,volume;
...
/**
   ...
   JK, 6. 3. 2024
*/
void linwedget::res_capacity_matrix (long eid,matrix &cm)
{
  long i,j,*rcn,*ccn;
  matrix lcm;
...
/**
   ...
   JK, 6.1.2002
*/
void linwedget::res_convection_vector (vector &f,long lcid,long eid,long leid)
{
  long *cn;
  vector lf;
...
/**
   ...
   JK, 6.1.2002
*/
void linwedget::res_transmission_vector (vector &f,long lcid,long eid,long leid)
{
  long *cn,i;
  vector lf;
...
/**
   ...
   JK, 6.1.2002
*/
void linwedget::res_quantity_source_vector (vector &sv,vector &nodval,long lcid,long eid)
{
  long *cn;
  vector lsv;
...
*/
/*
void linwedget::res_internal_fluxes (long eid, vector &elemif)
{
  long i;
  vector lif, tdnv;
  ivector cn;
...
*/
/*
double linwedget::total_integral(long eid,vector &nodval)
{
  long i,j,k;
...
/**
   ...
   TKr, 28.2.2004
*/
void linwedget::res_boundary_flux (vector &f,long lcid,long eid,long leid)
{
  long *cn,i;
  vector lf;
...
*/
/*
void linwedget::nod_grads_ip (long eid)
{
  long i,j,k,ipp;
  double vol;
...
*/
 /*
void linwedget::nod_fluxes_ip (long eid)
{
  long i,j,k,ipp;
  double vol;
  ivector ipnum(nne),nod(nne);
...
*/
 /*
void linwedget::nod_others_comp (long lcid,long eid,long ri,long ci)
{
...
*/
/*
void linwedget::nod_eqother_ip (long eid)
{
...
/**
   ...
   JK, 19.8.2004
*/
void linwedget::convection_vector (vector &v,long lcid,long eid,long leid,long ri,long ci)
{
  long i,ipp;
  bocontypet *bc;
  vector x(nne),y(nne),z(nne);
  ...
  for (i=0;i<nsurf;i++){
    ...
    if (bc[i]==2 || bc[i]==3 || bc[i]==4 || bc[i]==5){
      ...
      surface_integral (i,x,y,z,coef,km);
...
/**
   ...
   JK, 19.8.2004
*/
void linwedget::transmission_matrix (long lcid,long eid,long ri,long ci,matrix &km)
{
  long i,ipp,leid;
  bocontypet *bc;
  vector x(nne),y(nne),z(nne);
  ...
  for (i=0;i<nsurf;i++){
    ...
    if (bc[i]==4 || bc[i]==5 || bc[i]>10){
      ...
      //  matrix obtained from integration over surface
      surface_integral (i,x,y,z,coeff,km);
    }
  }
...
*/
void linwedget::transmission_vector (vector &v,long lcid,long eid,long leid,long cid)
{
  long i,ipp;
  bocontypet *bc;
  vector x(nne),y(nne),z(nne);
...
/**
   ...
   TKr, 28.2.2004
*/
void linwedget::boundary_flux (vector &v,long lcid,long eid,long leid,long ri,long ci)
{
  long i,ipp;
  bocontypet *bc;
  vector x(nne),y(nne),z(nne);
...
/**
   ...
   JK, 6. 3. 2024
*/
void linwedget::surface_integral (long surf,vector &x,vector &y,vector &z,
				  vector &coef,matrix &km)
{
  long i,j,intordt,intordz;
  ...
  if (surf==3){
    reallocv (intordt,wt);
    reallocv (intordt,gp1);
    reallocv (intordt,gp2);
    
    gauss_points_tr (gp1.a,gp2.a,wt.a,intordt);
...
*/
void linwedget::transf_flux (long surf,vector &coeff,vector &list,vector &trc,vector &trr,long eid,long ri,long ci,long ipp,bocontypet *bc)
{
  long i,j,k;
  double tr,new_flux;
  ...
  linwedge_surfnod (surfnod.a,surf);
...
void linwedget::transf_coeff (long surf,vector &coeff,vector &list,long eid,long ri,long ci,long ipp,bocontypet *bc)
{
  long i,j,k;
  double new_coeff;
  ivector nodes(nne),surfnod(nnsurf);
...
/**
   ...
   JK, 19.8.2004
*/
void linwedget::transf_val (long surf,vector &nodval,vector &list,vector &trc,vector &trr,long eid,long ri,long ci,long ipp,bocontypet *bc)
{
  long i,j,k;
...
/**
   ...
   JK, 19.8.2004
*/
void linwedget::surfnodeval (long surf,vector &nodval,vector &list)
{
  long i,j;
...
/**
   ...
   JK, 23.8.2011
*/
void linwedget::higher_to_lower_level (long eid,long *counter,double *buff)
{
  long i,ipp;
  vector gr(3);
...
/**
   ...
   TKo, 12.2016
*/
long linwedget::ipcoord (long eid, long ipp, long ri, long ci, vector &coord)
{
  long i, j, ii;
  double xi, eta, zeta;
  vector x(nne),y(nne),z(nne),w,wt,gp,gp1,gp2;
...
/**
   ...
   TKo, 12.2016
*/
long linwedget::ipncoord (long eid, long ipp, vector &ncoord)
{
  long i, j, ii, ri, ci;
  double xi, eta, zeta;
  vector w,wt,gp,gp1,gp2;
...
*/
void linwedget::surface_flux (long lcid,long eid,long beid,double *fluxes)
{
