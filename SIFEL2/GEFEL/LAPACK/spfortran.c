 ...
 *      Pointer to the element that is to be added to.
 *  Real  <input>  (double *) [REAL or DOUBLE PRECISION]
 *      Real portion of the number to be added to the element.
 *  Imag  <input>  (double *) [REAL or DOUBLE PRECISION]
...
double sfPseudoCondition(long *Matrix)
{
...
double sfCondition(long *Matrix, double NormOfMatrix, int *pError )
{
...
double sfLargestElement(long *Matrix)
{
...
double sfRoundoff(long *Matrix, double Rho)
{
