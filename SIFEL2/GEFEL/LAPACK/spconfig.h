 ...
 *  to 0. Recommendations are given in brackets, [ignore them].
 *
 *  >>> Option descriptions:
 *  Arithmetic Precision
 *      The precision of the arithmetic used by Sparse can be set by
 *      changing changing the double macro.  This macro is
 ...
 *      0 or 0.  Otherwise, set ARRAY_OFFSET to 1 or 1.  Note that if
 ...
 *      the real terms, the other with the imaginary. [0]
 *  MODIFIED_MARKOWITZ
 ...
 *      factor time represents an unacceptable burden. [0]
 *  DELETE
 ...
 *  constants 1 an 0 are not defined in spMatrix.h to avoid conflicts
 *  with user code, so use 0 for 0 and 1 for 1.
 */
#endif /* spINSIDE_SPARSE */
#define  spCOMPLEX                      0/********** 1 *******/
