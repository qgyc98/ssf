/*
  File:     quadquadrilattax.cpp
  Author:   Tomas Krejci, 28.9.2004
  Purpose:  twodimensional quadrilateral element with quadratic approximation functions for axisymmetric problems
*/
...
quadquadrilattax::quadquadrilattax (void)
{
  long i;
...
void quadquadrilattax::codnum (long *cn,long ri)
{
  long i;
  for (i=0;i<nne;i++){
    cn[i]=ordering[ri][i];
...
/**
   ...
   JK, 8.5.2002
*/
double quadquadrilattax::approx (double xi,double eta,vector &nodval)
{
  double f;
  vector bf(nne);
...
/**
   ...
   8.5.2002
*/
void quadquadrilattax::ipcoordblock (long eid,long ri,long ci,double **coord)
{
  long i,j,k;
  double xi,eta;
...
/**
  ...
  JK, 8.5.2002 
*/
void quadquadrilattax::intpointval (long eid)
{
...
/**
  ...
  TKr 06/11/2020 according to TKo
*/
void quadquadrilattax::initintpointval (long eid)
{
...
/**
   ...
   JK, 8.5.2002
*/
void quadquadrilattax::intpointgrad (long eid)
{
  long i,j,ii,jj,k,ipp;
  double xi,eta,jac;
  vector x(ASTCKVEC(nne)), y(ASTCKVEC(nne)), r(ASTCKVEC(ndofe));
  vector t(ASTCKVEC(nne)), gp, w, grad(ASTCKVEC(ncomp));
...
/**
   ...
   JK, 17.9.2005
*/
void quadquadrilattax::intpointother (long eid)
{
...
/**
   ...
   JK, 25.9.2001
*/
void quadquadrilattax::bf_matrix (matrix &n,double xi,double eta)
{
  fillm (0.0,n);
...
/**
   ...
   JK, 1.2.2003
*/
void quadquadrilattax::give_approx_fun (double &f,double xi,double eta,long i)
{
  double n[4];
...
/**
   ...
   JK, 25.9.2001
*/
void quadquadrilattax::grad_matrix (matrix &gm,vector &x,vector &y,double xi,double eta,double &jac)
{
  long i;
...
/**
   ...
   JK, 25.9.2001
*/
void quadquadrilattax::conductivity_matrix (long lcid,long eid,long ri,long ci,matrix &km)
{
  long i,j,ii;
...
/**
   ...
   JK, 4.10.2001
*/
void quadquadrilattax::capacity_matrix (long eid,long ri,long ci,matrix &cm)
{
  long i,j,ii;
  double jac,xi,eta,w1,w2,xinp,rho,c;
  ivector nodes(nne);
  vector x(nne),y(nne),w(intordcm[ri][ci]),gp(intordcm[ri][ci]),dens(nne);
  matrix n(1,dofe[ri][ci]);
...
/**
   ...
   JK, 4.10.2001
*/
void quadquadrilattax::quantity_source_vector (vector &sv,vector &nodval,long eid,long ri,long ci)
{
  long i,j;
...
/**
   ...
   JK, 31.3.2002
*/
void quadquadrilattax::internal_fluxes (long lcid,long eid,vector &ifl)
{
  long i,j,ipp;
...
/**
   ...
   JK, 6.1.2002
*/
void quadquadrilattax::res_conductivity_matrix (long eid,long /*lcid*/,matrix &km)
{
  long i,j,*rcn,*ccn;
  matrix lkm;
...
/**
   ...
   JK, 6.1.2002
*/
void quadquadrilattax::res_capacity_matrix (long eid,matrix &cm)
{
  long i,j,*rcn,*ccn;
  matrix lcm;
...
/**
   ...
   JK, 6.1.2002
*/
void quadquadrilattax::res_convection_vector (vector &f,long lcid,long eid,long leid)
{
  long *cn;
  vector lf;
...
/**
   ...
   JK, 6.1.2002
*/
void quadquadrilattax::res_transmission_vector (vector &f,long lcid,long eid,long leid)
{
  long *cn,i;
  vector lf;
...
/**
   ...
   JK, 6.1.2002
*/
void quadquadrilattax::res_quantity_source_vector (vector &sv,vector &nodval,long lcid,long eid)
{
  long *cn;
  vector lsv;
...
/**
   ...
   JK, 6.1.2002
*/
void quadquadrilattax::res_internal_fluxes (long eid,vector &elemif)
{
  long i;
  vector lif, tdnv;
  ivector cn;
...
/**
   ...
   TKr, 30.1.2004
*/
double quadquadrilattax::total_integral(long eid,vector &nodval)
{
  long i,j;
...
/**
   ...
   TKr, 28.2.2004
*/
void quadquadrilattax::res_boundary_flux (vector &f,long lcid,long eid,long leid)
{
  long *cn,i;
  vector lf;
...
/**
   ...
   TKr, 06/11/2020
*/
void quadquadrilattax::volume_rhs_vector (long /*lcid*/,long eid,long ri,long ci,vector &vrhs)
{
  long i,j,ii;
  double xinp,xi,eta,ww1,ww2,jac;
...
/**
   ...
   TKr, 06/11/2020
*/
void quadquadrilattax::volume_rhs_vector2 (long /*lcid*/,long eid,long ri,long ci,vector &vrhs)
{
  long i,j,k,ipp;
...
/**
   ...
   TKr, 06/11/2020
*/
void quadquadrilattax::res_volume_rhs_vector (vector &f,long eid,long /*lcid*/)
{
  long i,*cn;
  vector lf;
...
/**
   ...
   TKr, 06/11/2020
*/
void quadquadrilattax::res_volume_rhs_vector2 (vector &f,long eid,long /*lcid*/)
{
  long i,*cn;
  vector lf;
...
/**
   ...
   10.5.2002
*/
void quadquadrilattax::nod_others (long /*lcid*/,long eid,long ri,long ci)
{
...
/**
   ...
   JK, 19.8.2004
*/
void quadquadrilattax::convection_vector (vector &v,long lcid,long eid,long leid,long ri,long ci)
{
  long i,ipp;
  bocontypet *bc;
  ivector nodes(nne);
...
/**
   ...
   JK, 19.8.2004
*/
void quadquadrilattax::transmission_matrix (long lcid,long eid,long ri,long ci,matrix &km)
{
  long i,ipp,leid;
  bocontypet *bc;
  ivector nodes(nne);
...
*/
void quadquadrilattax::transmission_vector (vector &v,long lcid,long eid,long leid,long ri,long ci)
{
  long i,ipp;
  bocontypet *bc;
  ivector nodes(nne);
...
/**
   ...
   TKr, 28.2.2004
*/
void quadquadrilattax::boundary_flux (vector &v,long lcid,long eid,long leid,long ri,long ci)
{
  long i,ipp;
  bocontypet *bc;
  ivector nodes(nne);
...
/**
   ...
   JK
*/
void quadquadrilattax::edge_integral (long edg,vector &x,vector &y,long intord,vector &gp,vector &w,
...
*/
void quadquadrilattax::transf_flux (long edg,vector &coeff,vector &list,vector &trc,vector &trr,long eid,long ri,long ci,long ipp,bocontypet *bc)
{
  long i,j,k;
  double tr,new_flux;
...
void quadquadrilattax::transf_coeff (long edg,vector &coeff,vector &list,long eid,long ri,long ci,long ipp,bocontypet *bc)
{
  long i,j,k;
  double new_coeff;
  ivector nodes(nne),edgenod(nned);
...
/**
   ...
   JK, 19.8.2004
*/
void quadquadrilattax::transf_val (long edg,vector &nodval,vector &list,vector &trc,vector &trr,long eid,long ri,long ci,long ipp,bocontypet *bc)
{
  long i,j,k;
...
/**
   ...
   JK, 19.8.2004
*/
void quadquadrilattax::edgenodeval (long edg,vector &nodval,vector &list)
{
  long i,j;
...
/**
   ...
   TKo, 12.2016
*/
long quadquadrilattax::ipcoord (long eid, long ipp, long ri, long ci, vector &coord)
{
  long i, j, ii;
  double xi, eta;
...
/**
   ...
   TKo, 12.2016
*/
long quadquadrilattax::ipncoord (long eid, long ipp, vector &ncoord)
{
  long i, j, ii, ri, ci;
  double xi, eta;
  vector w, gp;
