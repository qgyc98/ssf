...
*/
double C60barmat::sat(double pc,double t)
{
...
*/
double C60barmat::dsat_dpc(double pc,double t)
{
  double dsw_dpc;
...
*/
double C60barmat::dsat_dt(double pc,double t)
{
...
/**
   ...
   @retval phi - porosity
*/
double C60barmat::C60bar_phi(double t)
{
  double phi;
...
*/
double C60barmat::C60bar_kintr(double /*pc*/,double pg,double t,double /*dam*/)
{
  double kintr,bk;//ad;
  state_eq tt;
...
*/
double C60barmat::C60bar_krg(double pc,double t)
{
  double krg,s;
...
*/
double C60barmat::C60bar_krw(double pc,double t,double rh)
{
  double krw,help,s;
...
/**
   ...
   @retval dd - ...
*/
double C60barmat::C60bar_dd(double pc,double t)
{
  double tau,dd;
...
*/
double C60barmat::C60bar_deff(double pc,double pg,double t)
{
...
*/
double C60barmat::C60bar_cps(double t)
{
  double cps;
...
*/
double C60barmat::C60bar_rhocp(double pc,double pg,double t)
{
...
*/ 
double C60barmat::C60bar_tau(double pc,double t)
{
  double phi,s,tau;
...
*/
double C60barmat::C60bar_lambdas(double t)
{
  double lambdas;
...
*/
double C60barmat::C60bar_lambdaeff(double pc,double /*pg*/,double t)
{
...
*/
double C60barmat::C60bar_hydw(double /*pc*/,double /*pg*/,double t)
{
  double fhy,hydw;
...
*/
double C60barmat::C60bar_dehydw_dt(double /*pc*/,double /*pg*/,double t)
{
...
*/
double C60barmat::C60bar_hydren(double /*pc*/,double /*pg*/,double /*t*/)
{
  return(hydren);
}
...
*/
double C60barmat::C60bar_fste(double /*pc*/,double /*pg*/,double /*t*/)
{
  return(fste);
}
...
/**
   ...
   @retval  - diffusivity of bound water - according to Fortran code
*/
double C60barmat::C60bar_ddbw(double /*pc*/,double /*pg*/,double t)
{
  double ddbw;
...
*/
double C60barmat::C60bar_emod(double /*pc*/,double /*pg*/,double t)
{
  double emod,ttc;
...
*/
double C60barmat::C60bar_fct(double /*pc*/,double /*pg*/,double t)
{
  double fct,ttc;
...
*/
double C60barmat::C60bar_xk0(double pc,double pg,double t)
{
  double fct,emod,xk0;
...
*/
double C60barmat::C60bar_bcc(double /*pc*/,double /*pg*/,double t)
{
  double bcc,ttc;
...
/**
   ...
   29. 11. 2013, by TKo
*/
void C60barmat::give_reqntq(long *antq)
{
  //  damage parameter
