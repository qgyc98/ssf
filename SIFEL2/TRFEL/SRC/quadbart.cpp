/*
  ...
  Purpose:  onedimensional element with quadratic approximation functions
*/
#include "globalt.h"
#include "quadbart.h"
#include "genfile.h"
...
void quadbart::codnum (long *cn,long ri)
{
  long i;
  for (i=0;i<nne;i++){
    cn[i]=ordering[ri][i];
...
/**
   ...
   JK, 31.3.2002
*/
double quadbart::approx (double xi,vector &nodval)
{
  double f;
  vector bf(nne);
...
/**
   ...
   JK, 31.3.2003   
*/
void quadbart::intpointval (long eid)
{
  long i,k,ii,jj,ipp;
  double xi,val;
...
/**
   ...
   JK, 31.3.2003   
*/
void quadbart::intpointgrad (long eid)
{
  long i,ii,jj,k,ipp;
  double xi,jac;
...
/**
   ...
   JK, 17.9.2005
*/
void quadbart::intpointother (long eid)
{
...
/**
   ...
   JK, 31.3.2002
*/
void quadbart::bf_matrix (matrix &n,double xi)
{
  nullm (n);
  bf_quad_1d (n.a,xi);
}
...
/**
   ...
   JK, 31.3.2002
*/
void quadbart::grad_matrix (matrix &gm,vector &x,double xi,double &jac)
{
  long i;
  vector dx(nne);
...
/**
   ...
   JK, 31.3.2002
*/
void quadbart::conductivity_matrix (long lcid,long eid,long ri,long ci,matrix &km)
{
  long i,ii;
...
/**
   ...
   JK, 31.3.2002
*/
void quadbart::capacity_matrix (long eid,long ri,long ci,matrix &cm)
{
  long i,ii;
...
/**
   ...
   JK, 31.3.2002
*/
void quadbart::quantity_source_vector (vector &sv,vector &nodval,long eid,long ri,long ci)
{
  long i;
...
*/
void quadbart::transmission_matrix (long lcid,long eid,long ri,long ci,matrix &km)
{
  long i,leid,ii;
  bocontypet bc[2];
  double xi,area;
...
*/
void quadbart::transmission_vector (vector &tmv,long lcid,long eid,long leid,long ri,long ci)
{
  long ii;
  bocontypet bc[2];
  double xi,area;
...
/**
   ...
   JK, 8.10.2001
*/
void quadbart::convection_vector (vector &f,long lcid,long eid,long leid,long ri,long ci)
{
  bocontypet bc[2];
  double xi,area;
  ivector nodes(nne);
  ...
  if (bc[0]==2 || bc[0]==3){
    ...
    av[0]=nodval[0];  av[1]=0.0;  av[2]=0.0;
  ...
  if (bc[1]==2 || bc[1]==3){
    ...
    av[0]=0.0;  av[1]=nodval[1];  av[2]=0.0;
    mxv (km,av,v);  addv (f,v,f);
  }
}
...
/**
   ...
   JK, 31.3.2002
*/
void quadbart::internal_fluxes (long lcid,long eid,vector &ifl)
{
  long i,ipp;
  double jac,area,xi;
  ivector nodes(nne);
...
/**
   ...
   JK, 6.1.2002
*/
void quadbart::res_conductivity_matrix (long eid,long /*lcid*/,matrix &km)
{
  long i,j,*rcn,*ccn;
  matrix lkm;
...
/**
   ...
   TKr, 23/02/2011
*/
void quadbart::volume_rhs_vector (long /*lcid*/,long eid,long ri,long ci,vector &vrhs)
{
  long i,ii;
  double area,xi,ww,jac;
  ivector nodes(nne);
  vector x(nne),w(intordkm[ri][ci]),gp(intordkm[ri][ci]),v(dofe[ri][ci]),a(nne);
  matrix gm(ncomp,dofe[ri][ci]),d;
...
/**
   ...
   TKr, 23/02/2011
*/
void quadbart::res_volume_rhs_vector (vector &f,long eid,long /*lcid*/)
{
  long i,*cn;
  vector lf;
...
/**
   ...
   JK, 6.1.2002
*/
void quadbart::res_capacity_matrix (long eid,matrix &cm)
{
  long i,j,*rcn,*ccn;
  matrix lcm;
...
/**
   ...
   JK, 6.1.2002
*/
void quadbart::res_convection_vector (vector &f,long lcid,long eid,long leid)
{
  long *cn;
  vector lf;
...
/**
   ...
   JK, 6.1.2002
*/
void quadbart::res_transmission_vector (vector &f,long lcid,long eid,long leid)
{
  long *cn,i;
  vector lf;
...
/**
   ...
   JK, 6.1.2002
*/
void quadbart::res_quantity_source_vector (vector &sv,vector &nodval,long lcid,long eid)
{
  long *cn;
  vector lsv;
...
/**
   ...
   JK, 6.1.2002
*/
void quadbart::res_internal_fluxes (long eid,vector &elemif)
{
  long i;
  vector lif, tdnv;
  ivector cn;
...
/**
   ...
   TKr, 30.1.2004
*/
double quadbart::total_integral(long eid,vector &nodval)
{
  long i;
...
/**
   ...
   TKr, 28.2.2004
*/
void quadbart::boundary_flux (vector &tmv,long lcid,long eid,long leid,long ri,long ci)
{
  long ii;
  bocontypet bc[2];
  double xi,area;
...
/**
   ...
   TKr, 28.2.2004
*/
void quadbart::res_boundary_flux (vector &f,long lcid,long eid,long leid)
{
  long *cn,i;
  vector lf;
...
/**
   ...
   TKr, 23/02/2011
*/
void quadbart::nod_others_comp (long /*lcid*/,long eid,long ri,long ci)
{
...
/**
   ...
   TKo, 12.2016
*/
long quadbart::ipcoord (long eid, long ipp, long ri, long ci, vector &coord)
{
  long i, ii;
  double xi;
...
/**
   ...
   TKo, 12.2016
*/
long quadbart::ipncoord (long eid, long ipp, vector &ncoord)
{
  long i, ri, ci, ii;
  double xi;
  vector w, gp;
