...
/**
   JK, 11.4.2019
*/
double glasgowmatc::give_rhov (long nn)
{
  long k;
  double rhov;
  
  k=Gtt->give_dof(nn,0);
  if (k>0)   {rhov = Lsrst->lhs[k-1]+Lsrst->lhsi[k-1];}
  if (k==0)  {rhov = 0.0;}
  if (k<0)   {rhov = Tb->lc[0].pv[0-k-1].getval(Tp->time);}
...
/**
   JK, 11.4.2019
*/
double glasgowmatc::give_pg (long nn)
{
  long k;
  double pg;
...
/**
   JK, 11.4.2019
*/
double glasgowmatc::give_temp (long nn)
{
  long k;
  double t;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcond_u (matrix &d,long ri,long ci,long ipp)
{
  long m;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcap_u (matrix &d,long ri,long ci,long ipp)
{
  long m;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcond1d_u (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double rhov,pg,t;
  k = 0.0;
  
  rhov = Cmu->ip[ipp].av[0];//*scale_rhov;//scaling
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcond2d_u (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double rhov,pg,t;
  k = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcond3d_u (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double rhov,pg,t;
  k = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcap1d_u (matrix &d,long ri,long ci,long ipp)
{
  double c;
  double rhov,pg,t;
  c = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcap2d_u (matrix &d,long ri,long ci,long ipp)
{
  double c;
  double rhov,pg,t;
  c = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcap3d_u (matrix &d,long ri,long ci,long ipp)
{
  double c;
  double rhov,pg,t;
  c = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcond_l (matrix &d,long ri,long ci,long ipp)
{
  long m;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcap_l (matrix &d,long ri,long ci,long ipp)
{
  long m;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcond1d_l (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double rhov,pg,t;
  k = 0.0;
  
  rhov = Cml->ip[ipp].av[0];//*scale_rhov;//scaling
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcond2d_l (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double rhov,pg,t;
  k = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcond3d_l (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double rhov,pg,t;
  k = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcap1d_l (matrix &d,long ri,long ci,long ipp)
{
  double c;
  double rhov,pg,t;
  c = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcap2d_l (matrix &d,long ri,long ci,long ipp)
{
  double c;
  double rhov,pg,t;
  c = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::matcap3d_l (matrix &d,long ri,long ci,long ipp)
{
  double c;
  double rhov,pg,t;
  c = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::rhs_u1 (matrix &d,long ri,long ci,long ipp)
{
  long m;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::rhs1d_u1 (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double rhov,pg,t;
  k = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::rhs2d_u1 (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double rhov,pg,t;
  k = 0.0;
...
/**
   ...
   17.07.2005
*/
void glasgowmatc::rhs3d_u1 (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double rhov,pg,t;
  k = 0.0;
...
void glasgowmatc::read (XFILE *in)
{
...
/**  Calculate Far Field Temperature
     ...
     @retval tinf  - 
*/
double glasgowmatc::f_tinf (double time)
{
  double tinf;
...
/**  Calculate Vapour Pressure
     ...
     @retval   - 
*/
double glasgowmatc::f_pv (double rhov, double t)
{
  double pv;
...
/**  Calculate Saturation Vapour Pressure
     ...
     @retval   - 
*/
double glasgowmatc::f_psat(double t)
{
  double psat;
...
/**  Calculate Derivative of Saturation Vapour Pressure wrt Temperature
     ...
     @retval   - 
*/
double glasgowmatc::f_dpsatdt (double t)
{
  double dpsatdt;
...
/**  Calculate Density of Liquid Water
     ...
     @retval   - 
*/
double glasgowmatc::f_rhow (double /*t*/)
{
  double rhow;
...
/**  Calculate Density of Liquid Water
     ...
     @retval   - 
*/
double glasgowmatc::f_rhow0 (double /*t*/)
{
  double rhow0;
...
/**  Calculate  Derivative of Density of Liquid Water
     ...
     @retval   - 
*/
double glasgowmatc::f_drhowdt (double /*t*/)
{
  double drhowdt;
...
/**  Calculate Porosity
     ...
     @retval   - 
*/
double glasgowmatc::f_por (double t)
{
...
/**  Calculate Derivative of Porosity wrt Temperature
     ...
     @retval   - 
*/
double glasgowmatc::f_dpordt (double t)
{
...
/**  Calculate Volume Fraction of Free Water - from Sorption Isotherms
     ...
     @retval   - 
*/
double glasgowmatc::f_fracl0 (double t)
{
  double rhow0,fracl0;
...
/**  Calculate relative humidity
     ...
     @retval   - 
*/
double glasgowmatc::f_h (double rhov, double t)
{
  double pv,psat,h;
...
/**  Calculate factor m
     ...
     @retval   - 
*/
double glasgowmatc::f_m (double t)
{
  double m;
  double tc;
...
/**  Calculate factor mi
     ...
     @retval   - 
*/
double glasgowmatc::f_mi (double t)
{
  double m,mi;
  double tc;
...
/**  Calculate Derivative of m factor wrt Temperature
     ...
     @retval   - 
*/
double glasgowmatc::f_dmdt (double t)
{
  double m,dmdt;
  double tc;
...
/**  Calculate Derivative of mi factor wrt Temperature
     ...
     @retval   - 
*/
double glasgowmatc::f_dmidt (double t)
{
  double m,dmdt,dmidt;
  double tc;
...
/**  Calculate Volume Fraction of Water
     ...
     @retval   - 
*/
double glasgowmatc::f_fracl (double rhov, double t)
{
...
/**  Calculate Derivative of Volume Fraction of Water
     ...
     @retval   - 
*/
double glasgowmatc::f_dfracldt (double rhov, double t)
{
  double dfracldt;
...
/**  Calculate Vapour Content Derivative
     ...
     @retval   - 
*/
double glasgowmatc::f_dfracldrhov (double rhov, double t)
{
  double dfracldrhov;
...
/**  Calculate Mass of Dehydrated Water Released per m3
     ...
     @retval   - 
*/
double glasgowmatc::f_mcbwrel (double t)
{
...
/**  Calculate Derivative of Mass of Dehydrated Water Released per m3
     ...
     @retval   - 
*/
double glasgowmatc::f_dmcbwreldt (double t)
{
...
/**  Calculate Volume Fraction of Dehydrated Water
     ...
     @retval   - 
*/
double glasgowmatc::f_fracd (double t)
{
...
/**  Calculate Derivative of Volume Fraction of Dehydrated Water wrt Temperature
     ...
     @retval   - 
*/
double glasgowmatc::f_dfracddt(double t)
{
...
/**  Calculate Volume Fraction of Gas Phase 
     ...
     @retval   - 
*/
double glasgowmatc::f_fracg(double rhov, double t)
{
...
/**  Calculate Saturation 
     ...
     @retval   - 
*/
double glasgowmatc::f_s(double rhov, double t)
{
  double s,fracl,por;  
...
/**  Calculate pl
     ...
     @retval   - 
*/
double glasgowmatc::f_pl(long ipp, double pc, double pg, double t)
{
  double pl,s,rhov;
  rhov = Cmu->ip[ipp].av[0];//*scale_rhov;//scaling
...
/**  Calculate pc
     ...
     @retval   - 
*/
double glasgowmatc::f_pc (double rhov, double t)
{
  double pc,s,h,rhow;
...
/**  Calculate dpcdt
     ...
     @retval   - 
*/
double glasgowmatc::f_dpcdt (double rhov, double t)
{
...
/**  Calculate dpcdrhov
     ...
     @retval   - 
*/
double glasgowmatc::f_dpcdrhov (double rhov, double t)
{
...
/**  Calculate sln
     ...
     @retval   - 
*/
double glasgowmatc::f_sln (double rhov, double t)
{
  double sln,s;
...
/**  Calculate ppore
     ...
     @retval   - 
*/
double glasgowmatc::f_ppore (double rhov, double pg, double t, double pginf)
{
  double ppore;
...
/**  Calculate sb
     ...
     @retval   - 
*/
double glasgowmatc::f_sb (double rhov, double t)
{
  double sb,s;
...
/**  Calculate Dry Air Pressure
     ...
     @retval   - 
*/
double glasgowmatc::f_pa (double rhov, double pg, double t)
{
  double pa,pv;
...
/**  Calculate Air Content
     ...
     @retval   - 
*/
double glasgowmatc::f_rhoa (double rhov, double pg, double t)
{
  double rhoa,pa;
...
/**  Calculate Gas Content
     ...
     @retval   - 
*/
double glasgowmatc::f_rhog (double rhov, double pg, double t)
{
  double rhog,rhoa;
...
/**  Calculate dav - Calculate Gas Diffusivity
     ...
     @retval   - 
*/
double glasgowmatc::f_dav (double /*rhov*/, double pg, double t)
{
...
/**  Calculate DavEx - Calculate Gas Diffusivity
     ...
     @retval   - 
*/
double glasgowmatc::f_davex (double pg, double tinf)
{
...
/** Calculate Diffusivity of Physically Bound Water
     ...
     @retval   - 
*/
double glasgowmatc::f_db(double rhov, double t)
{
...
/**  Calculate Intrinsic Permeability 
     ...
     @retval   - 
*/
double glasgowmatc::f_kk (double t)
{
  double kk,por;
...
/**  Calculate Calculate Relative Permeability
     ...
     @retval   - 
*/
double glasgowmatc::f_kg (double rhov, double t)
{
  double kg,kb,km,s;
...
/**  Calculate Calculate Relative Permeability
     ...
     @retval   - 
*/
double glasgowmatc::f_kl (double rhov, double t)
{
  double kl,km,kb,s;
...
/**  Calculate Dynamic Viscosity of Liquid Water
     ...
     @retval   - 
*/
double glasgowmatc::f_mul (double t)
{
  double mul;
...
/**  Calculate Dynamic Viscosity of Water Vapour
     ...
     @retval   - 
*/
double glasgowmatc::f_muv (double t)
{
...
/**  Calculate Dynamic Viscosity of Dry Air
     ...
     @retval   - 
*/
double glasgowmatc::f_mua (double t)
{
...
/**  Calculate Dynamic Viscosity of Gas
     ...
     @retval   - 
*/
double glasgowmatc::f_mug (double rhov, double pg, double t)
{
...
/**  Calculate Specific Heat of Liquid Water
     ...
     @retval   - 
*/
double glasgowmatc::f_cl (double t)
{
  double cl;
...
/**  Calculate Specific Heat of Water Vapour
     ...
     @retval   - 
*/
double glasgowmatc::f_cv (double t)
{
  double cv;
...
/**  Calculate Specific Heat of Dry Air
     ...
     @retval   - 
*/
double glasgowmatc::f_ca (double  t)
{
  double ca;
...
/**  Calculate Specific Heat of Solid Skeleton
     ...
     @retval   - 
*/
double glasgowmatc::f_cs (double t)
{
  double cs,tc;
...
/**  Calculate Thermal Conductivity
     ...
     @retval   - 
*/
double glasgowmatc::f_keff (double t)
{
  double keff,tc;
...
/**  Calculate Volume Fraction of Solid Skeleton
     ...
     @retval   - 
*/
double glasgowmatc::f_fracs (double rhov, double t)
{
...
/**  Calculate Effective Heat Capacity
     ...
     @retval   - 
*/
double glasgowmatc::f_crho (double rhov, double pg, double t)
{
...
/**  Calculate Specific Heat of Evaporation
     ...
     @retval   - 
*/
double glasgowmatc::f_le (double t)
{
  double le;
...
/**  Calculate Radiative Heat Transfer Coefficient
     ...
     @retval   - 
*/
double glasgowmatc::f_hrad(double t, double tinf)
{
  double hrad;
...
/**  Calculate Combined Heat Transfer Coefficient
     ...
     @retval   - 
*/
double glasgowmatc::f_hqr(double t, double tinf)
{
  double hrad,hqr;
...
/**  Calculate Water Vapour Transfer Coefficient
     ...
     @retval   - 
*/
double glasgowmatc::f_beta (double pg, double tinf)
{
  double beta,davex;
...
/**  Calculate doplnit??!!
     ...
     @retval   - 
*/
double glasgowmatc::f_alpha (double t)
{
  //added by Tomas Krejci 21.6.2004
  ...
  tt = (tt - 20.0)/100.0;
  if(tt >= 0.0 && tt <= 6.0)
    alpha = 6.0e-5/(7.0 - tt);//I don't know, if it is in deg. C or deg. K.
  else
    alpha = 0.0;
...
double glasgowmatc::ktt (double t,double /*pg*/,double rhov)
{
  double ktt,keff;
...
double glasgowmatc::ktp (double t,double /*pg*/,double rhov)
{
  double ktp,klp;
...
double glasgowmatc::ktv (double t,double /*pg*/,double rhov)
{
  double ktv;
...
double glasgowmatc::kat (double t,double pg,double rhov)
{
...
double glasgowmatc::kap (double t,double pg,double rhov)
{
  double kap;
...
double glasgowmatc::kav (double t,double pg,double rhov)
{
  double kav;
...
double glasgowmatc::kmt (double t,double pg,double rhov)
{
  double kmt,klt,kvt;
  double dav,fracg,rhoa,rhog;
...
double glasgowmatc::kmp (double t,double pg,double rhov)
{
  double kmp,kvp,klp;
  double dav,fracg,rhoa,rhog;
  double sb,s,fracl,rhow,kk,kl,mul,le;
...
double glasgowmatc::kmv (double t,double pg,double rhov)
{
  double kmv,kvv,klv;
...
double glasgowmatc::ctt (double t,double pg,double rhov)
{
  double ctt;
...
double glasgowmatc::ctp ()
{
  return 0.0;
}

double glasgowmatc::ctv (double t,double /*pg*/,double rhov)
{
  double ctv;
...
double glasgowmatc::cat (double t,double pg,double rhov)
{
  double cat;
...
double glasgowmatc::cap (double t,double /*pg*/,double rhov)
{
  double cap;
  double fracg;
...
double glasgowmatc::cav (double t,double pg,double rhov)
{
  double cav;
...
double glasgowmatc::cmt (double t,double /*pg*/,double rhov)
{
  double cmt;
...
double glasgowmatc::cmp ()
{
  return 0.0;
}

double glasgowmatc::cmv (double t,double /*pg*/,double rhov)
{
  double cmv;
...
*/
double glasgowmatc::transmission_transcoeff(double trc,long ri,long ci,long nn,long bc,long ipp)
{
...
/**
   ...
   @param ipp        - number of first integration point on element
*/
double glasgowmatc::transmission_nodval(double nodval,double /*trc2*/,long ri,long ci,long nn,long bc,long ipp)
{
...
/**
   ...
   @param ipp        - number of first integration point on element
*/
double glasgowmatc::transmission_flux(double nodval,double /*trc2*/,long ri,long ci,long nn,long bc,long ipp)
{
...
/**
   ...
   @param ipp - number of first integration point on element
*/
double glasgowmatc::get_transmission_transcoeff_mv(double t,double pg,double /*rhov*/,long bc,long /*ipp*/)
{
  double trc;
...
/**
   ...
   @param ipp - number of first integration point on element
*/
double glasgowmatc::get_transmission_nodval_mv(double bv,double t,double pg,double rhov,long bc,long /*ipp*/)
{
  double nodval;
...
/**
   ...
   @param ipp - number of first integration point on element
*/
double glasgowmatc::get_transmission_flux_mv(double bv,double t,double pg,double rhov,long bc,long /*ipp*/)
{
  double flux;
...
/**
   ...
   @param ipp - number of first integration point on element
*/
double glasgowmatc::get_transmission_transcoeff_tt(double t,double /*pg*/,double /*rhov*/,long bc,long /*ipp*/)
{
  double trc;
...
/**
   ...
   @param ipp - number of first integration point on element
*/
double glasgowmatc::get_transmission_nodval_tt(double bv,double t,double /*pg*/,double /*rhov*/,long bc,long /*ipp*/)
{
  double nodval;
...
/**
   ...
   @param ipp - number of first integration point on element
*/
double glasgowmatc::get_transmission_flux_tt(double bv,double t,double /*pg*/,double /*rhov*/,long bc,long /*ipp*/)
{
  double flux;
...
/**
   ...
   @param ipp - number of first integration point on element
*/
double glasgowmatc::get_transmission_transcoeff_mt(double t,double pg,double rhov,long bc,long /*ipp*/)
{
  double trc;
...
/**
   ...
   @param ipp - number of first integration point on element
*/
double glasgowmatc::get_transmission_nodval_mt(double bv,double t,double pg,double rhov,long bc,long /*ipp*/)
{
  double nodval;
  double kvt,keff,hqr,tinf;
  double dav,fracg,rhoa,rhog;
...
/**
   ...
   @param ipp - number of first integration point on element
*/
double glasgowmatc::get_transmission_flux_mt(double bv,double t,double pg,double rhov,long bc,long /*ipp*/)
{
  double flux;
  double kvt,keff,hqr,tinf;
  double dav,fracg,rhoa,rhog;
...
double glasgowmatc::get_othervalue(long compother,long ipp, double *r)
{
  double other;
...
/**
     ...
     @param compother - number of other components
*/
void glasgowmatc::print_othervalue_name(FILE *out,long compother)
{
  switch (compother){
  case 0:{//concentration of water vapour
...
double glasgowmatc::kuu (double /*t*/,double /*pg*/,double /*rhov*/)
{
  double kuu;

  switch (model){
  case 1:{
    kuu = 0.0;//not completed???!!!
    break;
  }
  case 2:{
    kuu = 0.0;//not completed???!!!
...
double glasgowmatc::kut (double t,double /*pg*/,double /*rhov*/)
{
  double kut;
...
double glasgowmatc::kut2 (double t,double /*pg*/,double rhov)
{
  double kut,sln,dpcdt;
...
double glasgowmatc::kup (double /*t*/,double /*pg*/,double /*rhov*/)
{
  double kup;
...
double glasgowmatc::kuv (double t,double /*pg*/,double rhov)
{
  double kuv,sln,dpcdrhov;
...
*/
double glasgowmatc::emod()//temporarily
{
  double emod0;
...
/**
   ...
   @param t    - temperature
   @param rhov - vapour content
*/

double glasgowmatc::fuv1(double /*t*/,double /*pg*/,double /*rhov*/)
{
  return(0.0);
}
...
double glasgowmatc::fup1(double /*t*/,double /*pg*/,double /*rhov*/)
{
  return(0.0);
}
...
double glasgowmatc::fut1(double t,double /*pg*/,double /*rhov*/)
{
  double fut1;
