...
*/
double baroghelmatc::baroghel_sw(double pc,double /*t*/)
{
...
*/
double baroghelmatc::baroghel_dsw_dpc(double pc,double /*t*/)
{
  double dsw_dpc;
...
*/
double baroghelmatc::baroghel_dsw_dt(double /*pc*/,double /*t*/)
{
  double dsw_dt;
...
*/
double baroghelmatc::baroghel_ssp()
{
  return(0.55);
}
...
*/
double baroghelmatc::baroghel_krg(double s)
{
  double krg;
...
*/
double baroghelmatc::baroghel_krw(double pc, double t)
{
  double krw,s;
...
/**
   ...
   @retval phi - porosity
*/
double baroghelmatc::baroghel_phi()
{
  double phi;
...
*/
double baroghelmatc::baroghel_kintr()
{
  double kintr;
...
*/
double baroghelmatc::baroghel_cps()
{
  double cps;
...
*/
double baroghelmatc::baroghel_rhocp(double pc,double pg,double t)
{
...
*/
double baroghelmatc::baroghel_cp(double pc,double pg,double t,long ipp)
{
...
*/ 
double baroghelmatc::baroghel_tau(double pc,double t)
{
  double phi,s,tau;
...
/**
   ...
   @retval dd - ...
*/
double baroghelmatc::baroghel_dd(double pc,double t)
{
  double tau,dd;
...
*/
double baroghelmatc::baroghel_deff(double pc,double pg,double t)
{
...
*/
double baroghelmatc::baroghel_lambdaeff(double pc,double /*pg*/,double t)
{
...
*/
double baroghelmatc::baroghel_rhos()
{
  double rhos;
...
*/
double baroghelmatc::baroghel_betas()
{
  return(betas);
}
...
*/
double baroghelmatc::baroghel_alpha()
{
  return(alpha);
}
...
*/
double baroghelmatc::baroghel_hydw(double /*pc*/,double /*pg*/,double t)
{
  double fhy,hydw;
...
*/
double baroghelmatc::baroghel_dehydw_dt(double /*pc*/,double /*pg*/,double t)
{
...
*/
double baroghelmatc::baroghel_hydren(double /*pc*/,double /*pg*/,double /*t*/)
{
  return(hydren);
}
...
*/
double baroghelmatc::baroghel_fste(double /*pc*/,double /*pg*/,double /*t*/)
{
  return(fste);
}
...
*/
double baroghelmatc::baroghel_ddbw(double /*pc*/,double /*pg*/,double t)
{
  double ddbw;
...
*/
double baroghelmatc::baroghel_emod()
{
  return(emod);
}
...
*/
double baroghelmatc::baroghel_nu()
{
  return(nu);
}
...
/**
   ...
   @param in - input file
*/
void baroghelmatc::read(XFILE *in)
{
