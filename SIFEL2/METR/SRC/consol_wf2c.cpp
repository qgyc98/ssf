...
/**
   ...
   29/10/2009, TKr
*/
void con_wf2matc::read(XFILE *in)
{
...
/**
   ...
   29/10/2009, TKr
*/
void con_wf2matc::print(FILE *out)
{
  fprintf (out,"\n %d ", int(model_type));
  switch (model_type){
  case lewis_and_schrefler2_coup:{//Lewis and Schrefler's book
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcond_u (matrix &d,long ri,long ci,long ipp)
{
  long m;
  m = d.m;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcond1d_u (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double pw,pg;
  k = 0.0;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcond2d_u (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double pw,pg;
  k = 0.0;
...
/**
   ...
   11/06/2018, TKr
*/
void con_wf2matc::matcond2d_ax_u (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double pw,pg;
  k = 0.0;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcond3d_u (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double pw,pg;
  k = 0.0;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcap_u (matrix &d,long ri,long ci,long ipp)
{
  long m;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcap1d_u (matrix &d,long ri,long ci,long ipp)
{
  double pw,pg,c;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcap2d_u (matrix &d,long ri,long ci,long ipp)
{
  double pw,pg,c;
...
/**
   ...
   11/06/2018, TKr
*/
void con_wf2matc::matcap2d_ax_u (matrix &d,long ri,long ci,long ipp)
{
  double pw,pg,c;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcap3d_u (matrix &d,long ri,long ci,long ipp)
{
  double pw,pg,c;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcond_l (matrix &d,long ri,long ci,long ipp)
{
  long m;
  m = d.n;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcond1d_l (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double pw,pg;
  k = 0.0;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcond2d_l (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double pw,pg;
  k = 0.0;
...
/**
   ...
   11/06/2018, TKr
*/
void con_wf2matc::matcond2d_ax_l (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double pw,pg;
  k = 0.0;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcond3d_l (matrix &d,long ri,long ci,long ipp)
{
  double k;
  double pw,pg;
  k = 0.0;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcap_l (matrix &d,long ri,long ci,long ipp)
{
  long m;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcap1d_l (matrix &d,long ri,long ci,long ipp)
{
  double pw,pg,c;
  c = 0.0;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcap2d_l (matrix &d,long ri,long ci,long ipp)
{
  double pw,pg,c;
  c = 0.0;
...
/**
   ...
   11/06/2018, TKr
*/
void con_wf2matc::matcap2d_ax_l (matrix &d,long ri,long ci,long ipp)
{
  double pw,pg,c;
  c = 0.0;
...
/**
   ...
   09/03/2011, TKr
*/
void con_wf2matc::matcap3d_l (matrix &d,long ri,long ci,long ipp)
{
  double pw,pg,c;
  c = 0.0;
...
/**
   ...
   @param ipp - number of integration point
*/
void con_wf2matc::rhs_u1 (matrix &d,long ri,long ci,long ipp)
{
  long m;
  m = d.m;
...
/**
   ...
   @param ipp - number of integration point
*/
void con_wf2matc::rhs1d1 (matrix &d,long /*ri*/,long /*ci*/,long ipp)
{
  double f,pw,pg;
...
/**
   ...
   @param ipp - number of integration point
*/
void con_wf2matc::rhs2d1 (matrix &d,long /*ri*/,long /*ci*/,long ipp)
{
  double f,pw,pg;
...
/**
   ...
   @param ipp - number of integration point
*/
void con_wf2matc::rhs2d_ax_1 (matrix &d,long /*ri*/,long /*ci*/,long ipp)
{
  double f,pw,pg;
...
/**
   ...
   @param ipp - number of integration point
*/
void con_wf2matc::rhs3d1 (matrix &d,long /*ri*/,long /*ci*/,long ipp)
{
  double f,pw,pg;
...
/**
   ...
   @param ipp - number of integration point
*/
void con_wf2matc::rhs_u2 (matrix &d,long ri,long ci,long ipp)
{
  long m;
  m = d.m;
...
/**
   ...
   @param ipp - number of integration point
*/
void con_wf2matc::rhs1d2 (matrix &/*d*/,long /*ri*/,long /*ci*/,long /*ipp*/)
{
}
...
/**
   ...
   @param ipp - number of integration point
*/
void con_wf2matc::rhs2d2 (matrix &/*d*/,long /*ri*/,long /*ci*/,long /*ipp*/)
{
}
...
/**
   ...
   @param ipp - number of integration point
*/
void con_wf2matc::rhs2d_ax_2 (matrix &/*d*/,long /*ri*/,long /*ci*/,long /*ipp*/)
{
}
...
/**
   ...
   @param ipp - number of integration point
*/
void con_wf2matc::rhs3d2 (matrix &/*d*/,long /*ri*/,long /*ci*/,long /*ipp*/)
{
}
...
/**
   ...
   29/10/2009, TKr
*/
double con_wf2matc::get_sw(double pw, double /*pg*/,long ipp)
{
  double sw;
...
/**
   ...
   13/04/2018, TKr
*/
double con_wf2matc::get_porosity(long ipp)
{
  double por;
...
/**
   ...
   29/10/2009, TKr
*/
double con_wf2matc::get_kuw(double pw, double pg, long ipp)
{
  double sw,kuw;
...
/**
   ...
   29/10/2009, TKr
*/
double con_wf2matc::get_kug(double pw, double pg, long ipp)
{
  double sw,sg,kug;
...
/**
   ...
   29/10/2009, TKr
*/
double con_wf2matc::get_kgu(double /*pw*/, double /*pg*/, long /*ipp*/)
{
  double kgu;
...
/**
   ...
   29/10/2009, TKr
*/
double con_wf2matc::get_kwu(double /*pw*/, double /*pg*/, long /*ipp*/)
{
  double kwu;
...
/**
   ...
   29/10/2009, TKr
*/
double con_wf2matc::get_capuw(double /*pw*/, double /*pg*/, long /*ipp*/)
{
  double capuw;
...
/**
   ...
   29/10/2009, TKr
*/
double con_wf2matc::get_capwu(double pw, double pg, long ipp)
{
...
/**
   ...
   29/10/2009, TKr
*/
double con_wf2matc::get_capug(double /*pw*/, double /*pg*/, long /*ipp*/)
{
  double capug;
...
/**
   ...
   29/10/2009, TKr
*/
double con_wf2matc::get_capgu(double pw, double pg, long ipp)
{
...
/**
   ...
   29/10/2009, TKr
*/
double con_wf2matc::get_fu1(double pw, double pg, long ipp)
{
...
/**
   ...
   12/06/2018, TKr
*/
double con_wf2matc::get_fu2(double /*pw*/, double /*pg*/, long /*ipp*/)
{
  return(0.0);
}
