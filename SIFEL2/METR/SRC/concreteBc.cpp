...
concreteBmatc::concreteBmatc()
{
  ...
  //nds = 1.5;
  /*******************************************************************************/
  emod = nu = rhos_th0 = betas = phi0 = aphi = ads = bds = nds = k0 = ak = bk = 0.0;
  cps0 = ac = c1 = 0.0;

  // cemenet content c1 is not read from input file !!!!
...
*/
double concreteBmatc::concreteB_sw(double pc,double t)
  //from F.Pesavento's PhD-thesis,pages 198-199
{
...
*/
double concreteBmatc::concreteB_dsw_dpc(double pc,double t)
  //from F.Pesavento's PhD-thesis,pages 198-199
{
...
*/
double concreteBmatc::concreteB_dsw_dt(double pc,double t)
  //from F.Pesavento's PhD-thesis,pages 198-199
{
...
*/
double concreteBmatc::concreteB_ssp()
{
  return(0.55);
}
...
*/
double concreteBmatc::concreteB_krg(double s)
{
  double krg;
...
*/
double concreteBmatc::concreteB_krw(double s,double rh)
{
  double krw,help;
...
/**
   ...
   @retval phi - porosity
*/
double concreteBmatc::concreteB_phi(double t)
{
  double phi;
...
*/
double concreteBmatc::concreteB_kintr(double pg,double t,double dam)
{
  double kintr,ad;
...
*/
double concreteBmatc::concreteB_cps(double t)
{
  double cps;
...
*/
double concreteBmatc::concreteB_rhocp(double pc,double pg,double t,long /*ipp*/)
{
...
*/
double concreteBmatc::concreteB_cp(double pc,double pg,double t,long ipp)
{
...
*/ 
double concreteBmatc::concreteB_fs(double pc,double t)
{
  double f,tau;
...
*/ 
double concreteBmatc::concreteB_tau(double pc,double t)
{
  double phi,s,tau;
...
*/
double concreteBmatc::concreteB_deff(double pc,double pg,double t)
{
...
*/
double concreteBmatc::concreteB_lambdaeff(double pc,double /*pg*/,double t)
{
...
*/
double concreteBmatc::concreteB_kt(double pc,double pg,double t)
{
  double kt,ks;
...
*/
double concreteBmatc::concreteB_ks(double /*pc*/,double /*pg*/,double /*t*/)
...
*/
double concreteBmatc::concreteB_rhos(double t)
{
  double rhos,rhos_th0,ah,aphi,phit,phi_th0;
...
*/
double concreteBmatc::concreteB_betas()
{
  return(betas);
}
...
*/
double concreteBmatc::concreteB_emod()
{
  return(emod);
}
...
*/
double concreteBmatc::concreteB_nu()
{
  return(nu);
}
...
*/
double concreteBmatc::concreteB_dmdh_dt(double /*pc*/,double /*pg*/,double t)
{
...
*/
double concreteBmatc::concreteB_dhdehydr(double /*pc*/,double /*pg*/,double /*t*/)
{
  double dhdehydr;
...
*/
double concreteBmatc::concreteB_drhos_dgammadh(double /*pc*/,double /*pg*/,double /*t*/)
{
...
*/
double concreteBmatc::concreteB_dgammadh_dt(double /*pc*/,double /*pg*/,double /*t*/)
{
  double dgammadh_dt;
...
/**
   ...
   @param in - input file
*/
void concreteBmatc::read(XFILE *in)
{
