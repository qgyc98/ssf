...
/**
   ...
   JK, 24.7.2001
*/
void loadcasec::read (XFILE *in,long lcid)
{
  ...
  */
  ...
  for (i=0;i<neb;i++){
    ...
    Ct->give_nbobjects (eid,nbo,nnbo);
  ...
  for(i=0;i<nmultfunc;i++){
    ...
    if ((k-1) != i){
      //print error
      fprintf (stderr,"\n\n wrong number of prescribed time function loadcasec::read (file %s, line %d).\n",__FILE__,__LINE__);
      exit(0);
    }
...
/**
   ...
   TKr, 3.1.2006
*/
void loadcasec::print (FILE *out,long lcid)
{
  long i;
...
*/
void loadcasec::assemble (long lcid,double *rhs)
{
...
/**
   ...
   TKr, 20.2.2004
*/
void loadcasec::assemble_flux (long lcid,double *rhs,long n)
{
  long i, ndofe, ndofemn, eid;
  vector r, f, lv, alv, nodval;
  ivector cn;
...
double loadcasec::give_fact (double t,long i)
{
...
ZDE JE KONEC NOVEHO ZAKOMENTOVANI
TO DOLE BYLO ZAKOMENTOVANO JIZ DRIVE  
*/
...
*/
/*
void loadcasec::sourcenodalvalues (long idse,vector &nodval)
{
  long i,j,k,m,nne;
...
*/
/*
void loadcasec::source_contrib (long lcid,double *rhs)
{
