...
/**
   ...
   JK, 9.5.2004
*/
double linwedge::approx (double xi,double eta,double zeta,vector &nodval)
{
  double f;
  vector bf(nne);
...
/**
   ...
   JK, 9.5.2004
*/
void linwedge::bf_matrix (matrix &n,double xi,double eta,double zeta)
{
  long i,j,k,l;
  vector bf(nne);
...
/**
   ...
   JK, 9.5.2004
*/
void linwedge::geom_matrix (matrix &gm,vector &x,vector &y,vector &z,
...
/**
   ...
   NOT PROVED
*/
void linwedge::transf_matrix (ivector &nodes,matrix &tmat)
{
  long i,n,m;
...
/**
   ...
   JK, 9.5.2004
*/
void linwedge::stiffness_matrix (long eid,long ri,long ci,matrix &sm)
{
...
/**
   ...
   JK, 9.5.2004
*/
void linwedge::res_stiffness_matrix (long eid,matrix &sm)
{
